...
?>
<h2 class="border-bottom border-4  border-dark d-inline"><?php echo $row1['category_name'];  ?></h2>
  <div>
<?php
...
if($page>1){
 ...
 <a class="page-link" href="index2.php?cid='.$cat_id.'&page='.($page-1).'" tabindex="-1" aria-disabled="true">Previous</a>
 </li>';
}
...
echo' <li class="page-item"><a class="page-link" href="index2.php?cid='.$cat_id.'&page='.$i.'">'.$i.'</a></li>';
 }
 if($total_page>$page){
   echo'<li class="page-item">
   <a class="page-link" href="index2.php?cid='.$cat_id.'&page='.($page+1).'">Next</a>
 </li>';
 }
